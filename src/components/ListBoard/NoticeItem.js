        ...
        <Grid item xs={12}>
          ...
          <Paper item xs={12} className={classes.paper}>
            ...
            <Grid container wrap="nowrap" spacing={0}>
              ...
              <Grid item xs={4} >
                <b><Icon className={classes.extendedIcon}>send</Icon> Jogo Cancelado</b>
                <b><Icon className={classes.extendedIcon}>send</Icon> Jogo Realizado</b>
              </Grid>
            </Grid>
...
export default withStyles(styles)(NoticeItem);